...
requests.put('https://bl48qfan7h.execute-api.us-east-1.amazonaws.com/dev/02211056-raw-sprint-3/scrapper_soybean_twitter.json', data=open('scrapper_soybean_twitter.json', 'rb'), headers=headers)